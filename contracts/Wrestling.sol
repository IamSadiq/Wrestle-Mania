...
contract Wrestling {
    ...
    */
    ...
    function registerAsAnOpponent() public {
        require(wrestler2 == address(0), "Add wrestler2 to account[0]");
    ...
    */
    function wrestle() public payable {
        require(!gameFinished && (msg.sender == wrestler1 || msg.sender == wrestler2), "Game not Finished and either wrestler selected");

        if(msg.sender == wrestler1) {
            require(wrestler1Played == false, "Wrestler1 not played");
            wrestler1Played = true;
            wrestler1Deposit = wrestler1Deposit + msg.value;
    	} else {
            require(wrestler2Played == false, "Wrestler2 not played");
    ...
    */
    function withdraw() public {
        require(gameFinished && theWinner == msg.sender, "Game Finished and Winner selected");
